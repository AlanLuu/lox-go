...
- `Iterator.urandomBig`, which is an iterator that produces endless amounts of cryptographically secure bytes as bigints
- `Iterator.zero`, which is an alias for `Iterator.zeroes`
- `Iterator.zeroBig`, which is an alias for `Iterator.zeroesBig`
- `Iterator.zeroes`, which is an iterator that produces endless amounts of the integer `0`
- `Iterator.zeroesBig`, which is an iterator that produces endless amounts of the bigint `0n`
