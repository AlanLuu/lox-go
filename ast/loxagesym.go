...
func (l *LoxAgeSymmetric) Get(name *token.Token) (any, error) {
	...
	case "decryptPEMToFile", "decryptPemToFile":
		return ageSymFunc(-1, func(_ *Interpreter, args list.List[any]) (any, error) {
			...
			case 2, 3:
				...
				default:
					return nil, loxerror.RuntimeError(name,
						"First argument to 'age symmetric.decryptPEMToFile' must be a buffer, file, or string.")
				}
				switch arg := args[1].(type) {
				case *LoxFile:
					if !arg.isWrite() && !arg.isAppend() {
						return nil, loxerror.RuntimeError(name,
							"Second file argument to 'age symmetric.decryptPEMToFile' must be in write or append mode.")
					}
				case *LoxString:
				default:
					return nil, loxerror.RuntimeError(name,
						"Second argument to 'age symmetric.decryptPEMToFile' must be a file or string.")
				}
				...
				if argsLen == 3 {
					...
					default:
						return nil, loxerror.RuntimeError(name,
							"Third argument to 'age symmetric.decryptPEMToFile' must be a string.")
					}
				} else if !l.initPassword {
					return nil, loxerror.RuntimeError(name,
						"Must specify password argument to 'age symmetric.decryptPEMToFile'.")
				}
				if len(password) == 0 {
				...
				case *LoxFile:
					if !arg.isRead() {
						return nil, loxerror.RuntimeError(name,
							"First file argument to 'age symmetric.decryptPEMToFile' must be in read mode.")
					}
					var readErr error
					ciphertext, readErr = io.ReadAll(arg.file)
					if readErr != nil {
				...
				if err != nil {
					...
					case *age.NoIdentityMatchError:
						return nil, loxerror.RuntimeError(name,
							"age symmetric.decryptPEMToFile: incorrect password")
					default:
						return nil, loxerror.RuntimeError(name, err.Error())
					}
				}
	...
	case "decryptPEMToStr", "decryptPemToStr":
		return ageSymFunc(-1, func(_ *Interpreter, args list.List[any]) (any, error) {
			...
			case 1, 2:
				...
				default:
					return nil, loxerror.RuntimeError(name,
						"First argument to 'age symmetric.decryptPEMToStr' must be a buffer, file, or string.")
				}
				...
				if argsLen == 2 {
					...
					default:
						return nil, loxerror.RuntimeError(name,
							"Second argument to 'age symmetric.decryptPEMToStr' must be a string.")
					}
				} else if !l.initPassword {
					return nil, loxerror.RuntimeError(name,
						"Must specify password argument to 'age symmetric.decryptPEMToStr'.")
				}
				if len(password) == 0 {
					return passwordErr(argsLen == 2)
				}
				...
				case *LoxFile:
					if !arg.isRead() {
						return nil, loxerror.RuntimeError(name,
							"File argument to 'age symmetric.decryptPEMToStr' must be in read mode.")
					}
					var readErr error
					ciphertext, readErr = io.ReadAll(arg.file)
					if readErr != nil {
				...
				if err != nil {
					...
					case *age.NoIdentityMatchError:
						return nil, loxerror.RuntimeError(name,
							"age symmetric.decryptPEMToStr: incorrect password")
					default:
						return nil, loxerror.RuntimeError(name, err.Error())
					}
				}
	...
	case "encryptPEMToFile", "encryptPemToFile":
		return ageSymFunc(-1, func(_ *Interpreter, args list.List[any]) (any, error) {
			...
			case 2, 3:
				...
				default:
					return nil, loxerror.RuntimeError(name,
						"First argument to 'age symmetric.encryptPEMToFile' must be a buffer, file, or string.")
				}
				switch arg := args[1].(type) {
				case *LoxFile:
					if !arg.isWrite() && !arg.isAppend() {
						return nil, loxerror.RuntimeError(name,
							"Second file argument to 'age symmetric.encryptPEMToFile' must be in write or append mode.")
					}
				case *LoxString:
				default:
					return nil, loxerror.RuntimeError(name,
						"Second argument to 'age symmetric.encryptPEMToFile' must be a file or string.")
				}
				...
				if argsLen == 3 {
					...
					default:
						return nil, loxerror.RuntimeError(name,
							"Third argument to 'age symmetric.encryptPEMToFile' must be a string.")
					}
				} else if !l.initPassword {
					return nil, loxerror.RuntimeError(name,
						"Must specify password argument to 'age symmetric.encryptPEMToFile'.")
				}
				if len(password) == 0 {
					return passwordErr(argsLen == 3)
				}
				...
				case *LoxFile:
					if !arg.isRead() {
						return nil, loxerror.RuntimeError(name,
							"First file argument to 'age symmetric.encryptPEMToFile' must be in read mode.")
					}
					var readErr error
					plaintext, readErr = io.ReadAll(arg.file)
					if readErr != nil {
	...
	case "encryptToPEMBuf", "encryptToPemBuf":
		return ageSymFunc(-1, func(_ *Interpreter, args list.List[any]) (any, error) {
			argsLen := len(args)
			switch argsLen {
			case 1, 2:
				...
				default:
					return nil, loxerror.RuntimeError(name,
						"First argument to 'age symmetric.encryptToPEMBuf' must be a buffer, file, or string.")
				}
				...
				if argsLen == 2 {
					...
					default:
						return nil, loxerror.RuntimeError(name,
							"Second argument to 'age symmetric.encryptToPEMBuf' must be a string.")
					}
				} else if !l.initPassword {
					return nil, loxerror.RuntimeError(name,
						"Must specify password argument to 'age symmetric.encryptToPEMBuf'.")
				}
				if len(password) == 0 {
					return passwordErr(argsLen == 2)
				}
				...
				case *LoxFile:
					if !arg.isRead() {
						return nil, loxerror.RuntimeError(name,
							"File argument to 'age symmetric.encryptToPEMBuf' must be in read mode.")
					}
					var readErr error
					plaintext, readErr = io.ReadAll(arg.file)
					if readErr != nil {
